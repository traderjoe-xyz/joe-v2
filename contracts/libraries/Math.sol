...
library Math {
    ...
    /// Its algorithm was slightly tweaked to round up the mulDivRoundDown.
    ///
    /// Requirements:
    ...
    function mulDivRoundUp(
        ...
        if (prod1 == 0) {
            if (prod0 != 0) {
                ...
                unchecked {
                    // This can't overflow
                    result = (prod0 - 1) / denominator + 1; // Rounds up the division
                }
            }
            return result;
        }
        ...
        if (prod1 >= denominator) {
            revert Math__MulDivOverflow(prod1, denominator);
        }
        ...
        assembly {
            ...
            result := sub(1, iszero(remainder)) // Rounds up the division
        ...
        return _endMulDiv(prod0, prod1, denominator, result);
    }
